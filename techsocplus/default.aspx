...
<body>
    <form id="form1" runat="server">
        <img src="tslogo.png" style="width: 200px; padding-bottom: 25px;"><br>
        ...
        <div class="container">
            <div style="font-size: 10pt; background-color: dimgray; width: 500px; padding: 10px;">
                <b>Upload a file to Techsoc+</b> (max 2 GB)<br><br>
        ...
        <div style="font-size: 8pt; color: silver;">
            <br><asp:Literal ID="litUsername" runat="server" />
            <br><br><asp:Button ID="btnLogout" runat="server" Text="Logout" OnClick="btnLogout_Click" />
        </div>
    </form>
</body>
</html>